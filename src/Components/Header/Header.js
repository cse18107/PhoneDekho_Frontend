    ...
    <div className="dashboard-right__header">
        <div className='header-content'>
            ...
            <div className='header-buttons'>
                <div className='header-notification-button' onClick={(showNotification)=>setShowNotification(!showNotification)}>
                    <div className='notification-content'>
                    <TextTooltip tooltipText="Show notification"><img src={bell} alt={"notification"}/></TextTooltip>
                ...
                <div className='header-logout-button'>
                    <TextTooltip tooltipText={"Logout"}><img src={logout} onClick={logoutHandler} alt="logout" tool/></TextTooltip>
                </div>
                <div className='header-profile-button'>
                   <Link to='/dashboard/your-profile'><TextTooltip tooltipText="Your profile"><img style={{"width":"50px","height":"50px"}} src={profile} alt="user"/></TextTooltip></Link> 
                </div>
            </div>
        </div>
    </div>
